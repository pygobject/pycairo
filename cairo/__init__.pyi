...
class PSSurface(Surface):
    ...
    def level_to_string(level: PSLevel) -> str:
        ...
        '''
    @staticmethod
    def ps_level_to_string(level: PSLevel) -> str:
        '''
...
class RasterSourcePattern(Pattern):
    ...
    class set_acquire:
        ...
        ----------
        >>> acquire (callable)\n
        Acquire callback or `None` to unset it.
        >>> release (callable)\n
        (optional) Release callback or `None`.
...
class SurfaceObserverMode(Enum):
    '''
...
FORMAT_A8 = Format.A8
FORMAT_A1 = Format.A1
FORMAT_RBG16_565 = Format.RGB16_565
...
STATUS_INVALID_MESH_CONTRUCTION = Status.INVALID_MESH_CONSTRUCTION
