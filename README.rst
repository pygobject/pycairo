...
works with **Python 2.7+** as well as **Python 3.5+**. Pycairo, including this
documentation, is licensed under the `LGPL-2.1-only OR MPL-1.1 <https://spdx.org/ids-how>`__.
